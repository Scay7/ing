	...
	<body>
        ...
        <div class="card">
        	<form id="formSelezionaCliente" action="datiInstallazione" method="post">
        		...
        		<%-- Stampa un anchor per la sezione di gestione dei dati installazione --%>
        		<%-- PLACEHOLDER, METTERE QUI ANCHOR out.println("<strong><a href=\"#gestoredatiinstallazione\">Gestisci Dati Installazione</a></strong>"); --%>
