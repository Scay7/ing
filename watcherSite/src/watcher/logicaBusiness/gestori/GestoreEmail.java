...
public class GestoreEmail {
	...
	private static class ServerMailConnector {
		/**Istanza usata per l'uso dei Log*/
		...
		private void configuraServer(Properties config) {
			 ...
			 *In particolare:
			 *	watchermail e la parola magica per l'accesso saranno le variabili che conterranno i parametri di accesso alla mail del mittente per autorizzare l'invio di altre email per conto di quest'ultimo
		...
		private void inviaEmail(String unDestinatario, String unOggetto, String unCorpo, File unAllegato, String unNomeAllegato) {
			try {  
				...
				LOGGER.log(Level.SEVERE, "Operazione non avvenuta");
			}
		}
	}
}
